...
//   border-color: #f44336;
// }
const inputColour = document.querySelector('#validation-input');
inputColour.addEventListener('blur', onBlur);
function onBlur(evt){
    const inputValue = evt.currentTarget.value;
    const lengthToCheck = +evt.currentTarget.getAttribute("data-length");
