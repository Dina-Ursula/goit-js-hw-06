...
loginForm.addEventListener('submit', onInput)
function onInput(evt) {
    ...
    if (!formElements.email.value || !formElements.password.value) {
        return alert('Заповніть форму будь ласка 😃😃')
    };
